...
const orderTypes = ["completed", "pending", "cancelled"];

export const handle = {
  breadcrumb: (match: UIMatch<ReturnType<typeof loader>, any>) => {
    return (
      <ParamDropdownItem
        breadcrumbLabel={match.params.orderType as string}
        paramLabel="Type"
...
export function loader() {
  return { orderTypes: ["completed", "pending", "cancelled"] };
}
...
export default function Orders() {
  ...
  return (
    <Stack>
      <Title order={3}>
        {orderType} Orders for {companyName}
      </Title>
      <Component />
    </Stack>
  );
